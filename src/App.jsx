  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-6 bg-gradient-to-br from-romantic-50 to-romantic-100">
      ...
      <main className="relative z-10 flex flex-col items-center text-center max-w-2xl w-full">
        ...
        >
          <div className="absolute -inset-4 bg-romantic-200 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition duration-500 animate-pulse-slow"></div>
          <HeartButton onClick={() => setIsLetterOpen(true)} />
          <p className="mt-4 text-sm text-gray-500 font-medium tracking-wide uppercase">Open My Heart</p>
        </motion.div>
      </main>
